<?php $wa = ld_whatsapp_url(); ?>
<footer class="ld-footer">
  <div class="ld-footer-grid">
    <!-- Marca -->
    <div>
      <img src="<?= get_template_directory_uri() ?>/assets/images/logo.png"
           alt="La Dulcería" width="80" height="80" style="border-radius:50%;margin-bottom:16px;">
      <p>Regalos únicos y personalizados. Porque cada momento merece ser especial. 🌸</p>
      <div class="ld-footer-social">
        <!-- WhatsApp -->
        <a href="<?= esc_url($wa) ?>" target="_blank" rel="noopener" aria-label="WhatsApp"
        ...
        <!-- Facebook -->
        <a href="#" aria-label="Facebook" style="background:#1877F2;">
    ...
    <div>
      ...
      <span style="font-size:.875rem;display:block;margin-bottom:8px;">📧 administracion@ladulceriaregalos.com</span>
      <a href="https://ladulceriaregalos.com/terminos-y-condiciones/">Términos y condiciones</a>
    </div>
  </div>

  <div class="ld-footer-bottom">
    Hecho con 💜 en Bogotá, Colombia &middot; &copy; <?= date('Y') ?> La Dulcería tienda de regalos
  </div>
</footer>
